...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "sendCommentsToApi": () => (/* binding */ sendCommentsToApi),
/* harmony export */   "reciveCommentsApi": () => (/* binding */ reciveCommentsApi),
/* harmony export */   "getData": () => (/* binding */ getData),
/* harmony export */   "getInvolvement": () => (/* binding */ getInvolvement)
/* harmony export */ });
const sendCommentsToApi = ({
  ...
  const getInvolvement = async (extension) => {
...
const displayCommentData = (movie, reciveCommentsApi, sendCommentsToApi, counter) => {
  ...
  /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (displayCommentData);
...
// Display Likes
const displayLikes = (domElement, data) => {
...
// POST Like to API
async function addLike(movieObj) {
...
/* harmony import */ var _app_popup_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./app/popup.js */ "./src/app/popup.js");
/* harmony import */ var _app_cards_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./app/cards.js */ "./src/app/cards.js");
/* harmony import */ var _app_utils_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./app/utils.js */ "./src/app/utils.js");
/* harmony import */ var _reservation_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./reservation.js */ "./src/reservation.js");
/* harmony import */ var _involvementApi_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./involvementApi.js */ "./src/involvementApi.js");
/* harmony import */ var _app_comment_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./app/comment.js */ "./src/app/comment.js");
/* harmony import */ var _counter_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./counter.js */ "./src/counter.js");
/* harmony import */ var _app_Itemscounter_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./app/Itemscounter.js */ "./src/app/Itemscounter.js");
/* harmony import */ var _reservationCounter_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./reservationCounter.js */ "./src/reservationCounter.js");
...
const renderMovies = () => {
  (0,_app_api_js__WEBPACK_IMPORTED_MODULE_2__.getData)().then((movies) => {
    (0,_app_Itemscounter_js__WEBPACK_IMPORTED_MODULE_10__["default"])(movies, moviesCounter);
    movies.forEach((movie, index) => {
      movieList.innerHTML += (0,_app_cards_js__WEBPACK_IMPORTED_MODULE_4__["default"])(movie, index); // render the cards
    });
    const spans = movieList.querySelectorAll('.spn-like');
    (0,_app_api_js__WEBPACK_IMPORTED_MODULE_2__.getInvolvement)('likes').then((data) => {
      (0,_app_utils_js__WEBPACK_IMPORTED_MODULE_5__.displayLikes)(spans, data);
    });
  });
};
renderMovies();
...
(function likeEvent() {
  ...
  document.addEventListener('click', (e) => {
    ...
    (0,_app_utils_js__WEBPACK_IMPORTED_MODULE_5__.addLike)(like);
  ...
  (0,_app_api_js__WEBPACK_IMPORTED_MODULE_2__.getData)().then((movies) => {
    movies.forEach((movie, index) => {
      ...
      reserveBtn[index].addEventListener('click', (e) => {
        e.preventDefault();
        modalReserve.innerHTML = (0,_reservation_js__WEBPACK_IMPORTED_MODULE_6__["default"])(movie);
        ...
        (0,_involvementApi_js__WEBPACK_IMPORTED_MODULE_7__.getReservation)(item_id).then((data) => {
          const reservationCnt = document.querySelector('.count-reservation');
          displayReservation(data);
          reservationCnt.innerHTML = `Reservations(${(0,_reservationCounter_js__WEBPACK_IMPORTED_MODULE_11__["default"])(data)})`;
        });
        btnSubmit.addEventListener('click', async (e) => {
          ...
          if (!(username && date_start && date_end)) {
            ...
            await (0,_involvementApi_js__WEBPACK_IMPORTED_MODULE_7__.postReservation)(data);
            await (0,_involvementApi_js__WEBPACK_IMPORTED_MODULE_7__.getReservation)(item_id).then((data) => {
              const reservationCnt = document.querySelector('.count-reservation');
              ulList.innerHTML = '';
              displayReservation(data);
  ...
  (0,_app_api_js__WEBPACK_IMPORTED_MODULE_2__.getData)().then((movies) => {
    movies.forEach((movie, index) => {
      ...
      commentButton.addEventListener('click', () => {
        modal.innerHTML += (0,_app_popup_js__WEBPACK_IMPORTED_MODULE_3__["default"])(movie);
        ...
        (0,_app_comment_js__WEBPACK_IMPORTED_MODULE_8__["default"])(movie, _app_api_js__WEBPACK_IMPORTED_MODULE_2__.reciveCommentsApi, _app_api_js__WEBPACK_IMPORTED_MODULE_2__.sendCommentsToApi, _counter_js__WEBPACK_IMPORTED_MODULE_9__["default"]);
      });
    });
  });
}
